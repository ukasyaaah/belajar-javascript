...
for (var j = 0; j < a.length; j++) {b.push (a[j] * 2)};
console.log(b);

//cari data bernilai 5 dalam array a dan hentikan pencarian // begitu data ditemukan
var c;

//sintaks alternatif, lebih efisien karena panjang array a //disimpan dalam variable len
for (var k = 0, len = a.length; k < len; k++){if (a[k] === 5){c = a[k];}
